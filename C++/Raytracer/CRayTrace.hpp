...
public:
    ...
    bool rayTrace9(const CScene& scene, CRay &ray, COutput& res);
    bool rayTrace12(const CScene& scene, CRay &ray, COutput& res);
    bool rayTrace13(const CScene& scene, CRay& ray, COutput& out);
    bool rayTrace14(const CScene& scene, CRay& ray, COutput& out);
    bool rayTrace16(const CScene& scene, CRay& ray, COutput& out);
